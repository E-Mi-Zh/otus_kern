...
def main():
    ...
    parser = argparse.ArgumentParser(description="Kernel memory allocation modules tester")
    parser.add_argument(
        "test_type",
        choices=["kmalloc", "vmalloc"],
        help="Test type: kmalloc for kmalloc testing module, vmalloc for vmalloc testing module",
    )
